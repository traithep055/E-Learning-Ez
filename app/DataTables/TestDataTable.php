    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function($query){
                $editBtn = "<a href='".route('teacher.tests.edit', ['test' => $query->id, 'course' => request()->query('course')])."' class='btn btn-primary' style='background-color: #ffc107;'><i class='far fa-edit'></i></a>";
                $deleteBtn = "<a href='".route('teacher.tests.destroy', $query->id)."' class='btn btn-danger delete-item' style='background-color: #e74c3c;'><i class='far fa-trash-alt'></i></a>";
